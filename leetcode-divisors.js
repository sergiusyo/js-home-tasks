...
/**
 * @param {number[]} nums - Массив целых положительных чисел.
 * @return {number} - Сумма делителей всех чисел, имеющих ровно четыре делителя.
 */
